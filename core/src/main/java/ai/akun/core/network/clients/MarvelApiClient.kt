...
import ai.akun.core.network.responses.BaseResponse
...
class MarvelApiClient(
    ...
    fun getCharacters(
        ...
        return flow<BaseResponse<CharacterResponse>> {
            emit(
                httpClient.request() {
                    url {
    ...
    fun getCharacterDetail(id: String): Flow<BaseResponse<CharacterResponse>> {
        return flow<BaseResponse<CharacterResponse>> {
            emit(
                httpClient.request() {
                    url {
